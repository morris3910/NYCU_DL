...
# Double convolution, blue arrow in the Unet
...
# Encoding path, double convolution + max pooling
class DownSample(nn.Module):
    ...
    def forward(self, x):
        down = self.conv(x) # we saved the convolutioned tensor for later skip connections, which is concatenated with upsampling path
        p = self.pool(down)
